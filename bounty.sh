...
SUBDOMAIN_ENUM="proxychains -q $reconftw/reconftw.sh -s"
VULN_SCAN="proxychains $reconftw/reconftw.sh -a"
...
# If a list of domains
    ...
    cat "$list" | xargs -P $threads -I {} $SUBDOMAIN_ENUM -d "{}"
